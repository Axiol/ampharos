  ...
  return (
    <>
      ...
      <div className="flex items-center mt-4">
        ...
        <button onClick={() => {navigator.clipboard.writeText(newLink)}} title="Copy to clipboard" className="p-2 ml-2 text-sm font-medium text-gray-500 transition-colors duration-200 transform bg-gray-300 rounded-md hover:bg-gray-200 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:bg-gray-600">
